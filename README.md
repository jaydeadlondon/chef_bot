# ChefBot — Твой AI-Шеф в Telegram

ChefBot — это интеллектуальный ассистент для планирования ужина, работающий на базе нейросети GigaChat. Бот помогает превратить имеющиеся в холодильнике продукты в полноценные рецепты, учитывая ваши диетические предпочтения, аллергии и количество персон.
...
Если нужно, могу добавить инструкцию по локальному запуску без Docker, примеры запросов к боту или описание таблиц базы данных.
